    ...
    <div class="content">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Create New Digital Markting</h4>
                        <button data-dismiss="modal" class="close">&times;</button>
                    </div>
                    <div class="modal-body">
                        <form id="insert_markting" enctype="multipart/form-data" class="md-form">
                            {{csrf_field()}}
        ...
        <div class="modal fade" id="edit_modalBox">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Edit Digital Markting</h4>
                        <button data-dismiss="modal" class="close">&times;</button>
                    </div>
                    <div class="modal-body">
                        <form id="update_data">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            function load(){
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        $('#insert_markting')[0].reset();

                    }
                });
            }

            $('#insert_markting').on('submit',function (e)
            {
                e.preventDefault();
                ...
                ({
                    ...
                    success: function(data){
                        ...
                        toastr.success('Insert markting data successful');
                        load();
                    }
                });
                return false;
            ...
            edit_data=function(id){
                $.ajax({
                    type: "POST",
                    url: "../edit/markting/"+id,

                    cache: false,
                    success: function(data){
                        reset();
                        var markting=JSON.parse(data);
                        //console.log(markting);
                        $('#id_edit').val(markting['id']);
                        $('#edit_title').val(markting['title']);
                        $('#edit_icon_name').val(markting['icon_name']);
                        ...
                        $('#edit_description').summernote('code',markting['description']);
                    }
                });
            }
            ...
            $('#update_data').on('submit',function (e)
            {
                ...
                ({
                    ...
                    success: function(data){
                        ...
                        $("#description").summernote('reset');
                        toastr.success('Update markting data successful');
                        load();
                    }
                });
                return false;
