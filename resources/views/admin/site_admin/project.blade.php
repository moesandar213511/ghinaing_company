            ...
            edit_data=function(id){
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        //console.log(project);
                        $("#imgs").attr("src", project['photo_url']);
                        $('#id_edit').val(project['id']);
                        $('#update_title').val(project['title']);
                        $('#update_link').val(project['link']);
                        ...
                        $('#update_description').summernote('code',project['description']);
            ...
            $('#update_data').on('submit',function (e)
            {
                ...
                ({
                    ...
                    success: function(data){
                        ...
                        toastr.success('Update description data successful');
                        load();
                    }
                });
                return false;
