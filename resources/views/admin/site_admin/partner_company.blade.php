            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">Create New PartnerCompany</h4>
                        <button data-dismiss="modal" class="close">&times;</button>
                    </div>
                    <div class="modal-body">
                        <form id="insert_partnercompany" enctype="multipart/form-data" class="md-form">
                            {{csrf_field()}}
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            function load(){
                $.ajax({
                    type: "POST",
                    url: "{{url('get_all_partnercompany')}}",
            ...
            $('#insert_partnercompany').on('submit',function (e)
            {
                e.preventDefault();
                ...
                ({
                    type: "POST",
                    url: "{{url('insert/partner_company')}}",
                    data:alldata,
                    cache:false,
                    processData: false,
                    contentType: false,
                    success: function(data){
                        ...
                        console.log(data);
                        $('#modalBox').modal('hide');
                        toastr.success('Insert PartnerCompany data successful');
                        load();
                    }
                });
                return false;
            ...
            edit_data=function(id){
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        //console.log(product);
                        $("#imgs").attr("src", partner['photo_url']);
                        $('#id_edit').val(partner['id']);
                        $('#update_link').val(partner['link']);
            ...
            $('#update_data').on('submit',function (e)
            {
                ...
                ({
                    ...
                    success: function(data){
                        ...
                        toastr.success('Update Partnercompany data successful');
                        load();
                    }
                });
                return false;
            ...
            delete_data=function(id){
                if(confirm('Are you sure You want to delete!')==true){
                    $.ajax({
                        ...
                        cache: false,
                        success: function(data){
                            toastr.success('Delete Partner data successful');
                            load();
                        }
                    });
                }else{
