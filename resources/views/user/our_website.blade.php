 ...
 @section('content') 
        ...
        <!--Home Section End-->
         ...
         <section id="software" style="margin-top: -200px!important;background-color: #fff;position: relative;z-index: 100;">
                <div class="container">
                  <div class="row">
                    <div class="col-md-12">
                      <div class="title-area text-center">
                        @foreach ($web_design as $data)
                            <h2 class="title" style="margin-top: 35px;">{{$data->title}}</h2>
